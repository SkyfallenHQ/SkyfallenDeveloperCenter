...
if (!$_SESSION["UPDATE_AUTHORIZED"] == "TRUE") {
    ...
    die("SDC stopped execution. Update not authorized.");
}
/**
...
function rrmdir($dir,$rmitself = true) {
    if (is_dir($dir)) {
        ...
        foreach ($objects as $object) {
            if ($object != "." && $object != ".." && $object != "UserData" && $object != "Configuration") {
...
if(isset($_SESSION["UPDATE_AUTHORIZED"]) and $_SESSION["UPDATE_AUTHORIZED"] == "TRUE") {
    ...
    <div class="sys-upgrade-wrap">
        ...
        <section class="sys-upgrade-text">
            <h3>SDC is upgrading...</h3>
            <p>It will be over in a few seconds.</p>
            <p>Get ready for a better SDC Experience!<p>
