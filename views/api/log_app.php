...
function execute_api_app_logging(){
    ...
    // Currently removed due to possible security exploits and massive data output
    ...
    if(validatePostData(['service_id','service_secret','provision_id','log_type','log_data'])){
        ...
        if($as){
            ...
            if($ob !== null) {
                ...
                $logid = SDC_LSLog::log($_POST['service_id'],$_POST['log_type'],$_POST['log_data']);
                $r['response']['log_id'] = $logid;
